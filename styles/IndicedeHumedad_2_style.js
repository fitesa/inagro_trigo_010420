...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.174875 && value <= -0.037033) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.037033 && value <= 0.100808) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.100808 && value <= 0.238649) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.238649 && value <= 0.376490) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.376490 && value <= 0.514331) {
            style = [ new ol.style.Style({
