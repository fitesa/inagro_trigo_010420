...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.134601 && value <= 0.289519) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.289519 && value <= 0.444438) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.444438 && value <= 0.599357) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.599357 && value <= 0.754275) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.754275 && value <= 0.909194) {
            style = [ new ol.style.Style({
